...
use Occu\Api\Middleware\JsonBodyFallbackMiddleware;
...
final class App
{
    public static function run(): void
    {
        ...
        // Parse JSON manual (fallback robusto). Lo agregamos DESPUÉS para que corra ANTES (LIFO),
        // y así ningún middleware (routing, etc.) consuma el stream primero.
        // Para form-data / x-www-form-urlencoded, Slim ya trae `parsedBody` desde $_POST cuando aplica.
        $app->add(new JsonBodyFallbackMiddleware());
