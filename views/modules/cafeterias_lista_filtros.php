...
<div class="offcanvas offcanvas-end offcanvas-unified slide-from-right filtros-offcanvas-desktop" tabindex="-1" id="offcanvasFiltros" aria-labelledby="offcanvasFiltrosLabel">
    <div class="offcanvas-header offcanvas-unified-header">
        <div class="offcanvas-unified-header-content">
            <h5 id="offcanvasFiltrosLabel" class="offcanvas-unified-title">
    ...
    <div class="offcanvas-body offcanvas-unified-body">
        <form onsubmit="return false;" id="aplicar_filtros_offcanvas" class="h-100 d-flex flex-column overflow-hidden">
...
<div class="offcanvas offcanvas-bottom offcanvas-unified slide-from-bottom height-large filtros-offcanvas-mobile" tabindex="-1" id="offcanvasFiltrosMobile" aria-labelledby="offcanvasFiltrosMobileLabel">
    <div class="offcanvas-header offcanvas-unified-header">
        <div class="offcanvas-unified-header-content">
            <h5 id="offcanvasFiltrosMobileLabel" class="offcanvas-unified-title">
                <i class="bi bi-funnel-fill"></i>
                <span>Filtros</span>
            </h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Cerrar"></button>
    ...
    <div class="offcanvas-body offcanvas-unified-body">
        <form onsubmit="return false;" id="aplicar_filtros_mobile" class="h-100 d-flex flex-column overflow-hidden">
