                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Nombre:</label>
                                <input type="text" class="form-control input_categorias validarCampo" tabla='menu_categorias' columna='nombre' mensaje='Esta categoría ya se encuentra registrada' id="nombre_categoria">
