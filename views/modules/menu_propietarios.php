...
<?php 
if (!isset($action[1])) {
    include "menu_propietarios/menu.php";
}else{
    if (!isset($action[2])) {
        if ($action[1]=='categorias') {
            include 'menu_propietarios/categorias.php';
        }else if ($action[1] == 'productos'){
            include 'menu_propietarios/productos.php';
        }else if ($action[1] == 'menu_qr'){
            include 'menu_propietarios/menu_qr.php';
        }else{
            include '404.php';
        }
    }else{
