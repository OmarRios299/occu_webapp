...
class MailchimpController
{
    ...
    static public function enviarFacturaController($datos)
    {

        $idMailChimp = MailchimpController::idMailchimpController();
        ...
        $date = new Datetime($datos['fecha_alta']);
        ...
        $message = [
            ...
            <div class="correo-contenido" style="text-align:center; margin: 0 auto; padding: 20px 40px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="background-color:#006E9F; text-align:center;">
                                            <img src="https://cmvet.mx/views/assets/css/img/logo/logo.png" alt="logo_cmv" style="width:120px; height: auto;margin: 15px auto 0; display: block;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: center;">
                                            <div style="background-color:#006E9F; padding:12px; text-align:center;">
                                                ...
                                                <p style="color: #fff">Fecha: 2024-10-16 </p>
                                            </div>
                                        </td>
                                    </tr>                         
                                </tbody>
                ...
                <br>
                <br>
                <p style="font-size: 10pt; color: #35d2d2; text-transform: uppercase; letter-spacing: 3px; margin: 0 auto;"><b>CMV</b></p>
                <br>
                <br>
            </div>',
            "to" => [
